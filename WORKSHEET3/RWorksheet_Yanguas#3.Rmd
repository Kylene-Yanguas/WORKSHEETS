...
```
```{r, include=TRUE}
#g. Name the rows as isa, dalawa, tatlo and 
#columns as uno, dos, tres, quatro for the matrix that was created in b.'. 
...
```
```{r, include=TRUE}
#h. From the original matrix you have created in a, 
#reshape the matrix by assigning a new dimension with dim(). 
...
#Each values will be repeated twice
...
#The array names should be "1st-Dimensional Array",
#"2nd-Dimentional Array", and "3rd-Dimensional Array". What will be the R codes and its output?

dimnames(array_dta) <- list(letters[1:2], LETTERS[1:4], 
                    c("1st-Dimensional Array", "2nd-Dimentional Array","3rd-Dimensional Array"))
array_dta
